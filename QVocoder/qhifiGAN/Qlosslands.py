...
config_file = "cp_hifigan2/config.json"
...
checkpoint_file = "cp_hifigan2/g_00027000"
...
with open('training.txt', 'r', encoding='utf-8') as fi:
        training_files = [os.path.join('../input_wavs/', x.split('|')[0] + '.wav')
