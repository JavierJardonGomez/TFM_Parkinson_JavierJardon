...
def train(a, h):
    ...
    for epoch in range(max(0, last_epoch), a.training_epochs):
                    ...
                    with torch.no_grad():
                        for j, batch in enumerate(validation_loader):
                            ...
                            y_g_hat_mel = mel_spectrogram(y_g_hat.squeeze(1), h.n_fft, h.num_mels, h.sampling_rate,
                                                          ...
                                                          h.fmin, h.fmax_for_loss)
                            """
                            min_len = min(y_mel.size(2), y_g_hat_mel.size(2))  # Encuentra el tamaño mínimo
                            y_mel = y_mel[:, :, :min_len]  # Recorta ambos al mismo tamaño
        ...
        with open(a.checkpoint_path+"/training_stats.json", "w") as f:
            json.dump(stats, f)
...
def main():
    ...
    #parser.add_argument('--input_wavs_dir', default='../wavs_augmented')
    #parser.add_argument('--input_mels_dir', default='ft_dataset')
    parser.add_argument('--input_mels_dir', default='../mels_e_22050Hz_normalize')
    #parser.add_argument('--input_mels_dir', default='../pre_processed_input_wavs_e_npy')
    #parser.add_argument('--input_training_file', default='training.txt')
    #parser.add_argument('--input_training_file', default='training_eng.txt')
    parser.add_argument('--input_training_file', default='training_e.txt')
    #parser.add_argument('--input_training_file', default='training_e_wavs_augmented.txt')
    #parser.add_argument('--input_validation_file', default='validation.txt')
    #parser.add_argument('--input_validation_file', default='validation_eng.txt')
    parser.add_argument('--input_validation_file', default='validation_e.txt')
    #parser.add_argument('--input_validation_file', default='validate_e_wavs_augmented.txt')
    
    #parser.add_argument('--checkpoint_path', default='cp_qhifigan6_eng') # my config
    parser.add_argument('--checkpoint_path', default='cp_final_v2_mels_batch16_lr')
    #parser.add_argument('--config', default='config_1_v3.json')
    parser.add_argument('--config', default='config_1_final_ft_16_lr.json')
    parser.add_argument('--training_epochs', default=20000, type=int)
